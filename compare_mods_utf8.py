...
with open('compare_output_utf8.txt','w',encoding='utf-8') as f:
    f.write('MISSING_FROM_CURRENT:\n')
    for m in missing:
        f.write(m + '\n')
    f.write('---\n')
    f.write('EXTRA_IN_CURRENT_NOT_IN_LIST:\n')
    for e in sorted(extra):
        f.write(e + '\n')
print('Wrote compare_output_utf8.txt')
